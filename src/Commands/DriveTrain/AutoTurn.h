...
{
private:
	static const int SAMPLE_SIZE = 35;
	double m_angle;
...
public:
	AutoTurn(double angle, bool reset = false,  float averageAngleTolerance = 1.0, float baseTurnSpeed = .55, float baseAdjustSpeed = .0036, float actualAngleTolerance = 2.0);
